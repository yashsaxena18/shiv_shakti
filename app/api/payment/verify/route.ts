...
if (existingPayment) {
  if (existingPayment.receiptNumber) {
    ...
    finalReceiptNumber = `SSMS-${Date.now()}-${Math.floor(
  ...
  paymentRecord = await prisma.payment.create({
    ...
    drawCenteredText(
      "Sidcul, Uttarakhand, India   |   +91 7088642658   |   shivshaktimultiservice.co.in",
      height - 78,
      7.5,
      regularFont,
      darkGray
    ...
    const transactionRows = [
      ...
      [
        "Amount Paid",
        `INR ${(paymentRecord.amount / 100).toFixed(2)}`,
      ],
      [
        "Currency",
    ...
    drawCenteredText(
      "Thank you for registering with Shiv Shakti Multi Service.",
      thankBoxY + 65,
      10,
      boldFont,
      black
    ...
    drawCenteredText(
      "www.shivshaktimultiservice.co.in",
      35,
      8,
      regularFont,
      darkGray
    ...
    const emailResult =
      await resend.emails.send({
        from:
          "noreply@shivshaktimultiservice.co.in",

        to: user.email,

        subject:
          "Payment Receipt - Shiv Shakti Multi Service",
        ...
        html: `
          ...
          ">
            ...
            <p>
              Your candidate registration payment
