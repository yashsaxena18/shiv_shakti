...
const benefits = [
  { number: "01", title: "Registration Process", description: "Pay a nominal fee starting at ₹499 (non-refundable) to create your candidate profile for the recruitment process." },
